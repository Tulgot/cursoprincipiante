...
class CategoriesHolder(view: View): RecyclerView.ViewHolder(view) {
    ...
    fun render(taskCategory: TaskCategory, onItemSelected: (Int) -> Unit) {
       // tvCategoryName.text = "Ejemplo"
        ...
        cvTaskCategory.setCardBackgroundColor(ContextCompat.getColor(divider.context, color))
        ...
        when(taskCategory){
            ...
            TaskCategory.Personal -> {
                ...
                divider.setBackgroundColor(
                    ContextCompat.getColor(divider.context, R.color.todo_perosnal_category)
                )
            }
